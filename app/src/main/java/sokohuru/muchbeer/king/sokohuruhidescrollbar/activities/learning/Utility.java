...
import static sokohuru.muchbeer.king.sokohuruhidescrollbar.activities.data.UkawaContract.getDbDateString;
...
public class Utility {
    ...
    public static boolean isMkoa(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(context.getString(R.string.pref_units_key),
                context.getString(R.string.pref_units_specific))
                .equals(context.getString(R.string.pref_units_specific));
    }

    static String formatDate(String dateString) {
        Date date = UkawaContract.getDateFromDb(dateString);
    ...
    public static String getFriendlyDayString(Context context, String dateStr) {
        ...
        String todayStr = UkawaContract.getDbDateString(todayDate);
        Date inputDate = UkawaContract.getDateFromDb(dateStr);
        ...
        if (todayStr.equals(dateStr)) {
           ...
           // String.format(context.getString(formatId,today,getFriendlyDayString(context, dateStr)));
